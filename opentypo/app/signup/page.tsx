  ...
  return (
    <div key="1" className="grid h-dvh w-full grid-cols-1 lg:grid-cols-2">
      <div className="relative hidden lg:block">
        <h1 className="absolute top-8 left-8">test</h1>
        <div className="flex flex-col z-20 absolute bottom-0 left-0 p-10 gap-4">
          <p className="text-white w-full text-3xl font-semibold text-balance">“Typography is the craft of endowing human language with a durable visual form.”</p>
          <p className="text-white w-full text-base font-regular text-balance">Robert Bringhurst, The Elements of Typographic Style</p>
        </div>
        <img
          ...
          <div className="space-y-5">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-background px-2 text-muted-foreground">이미 계정이 있으신가요?</span>
                </div>
            </div>
